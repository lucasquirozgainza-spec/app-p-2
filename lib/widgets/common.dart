  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        onTap: onTap,
        child: Padding(
          // El mosaico mide 88 de alto: con 18 arriba y abajo el contenido
          // (93 px) no entraba y la etiqueta se cortaba, más aún con letra
          // grande. El texto es Flexible: nunca desborda.
